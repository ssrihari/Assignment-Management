...
public class ExternalAssignmentImportWizard extends Wizard implements
        IImportWizard {
    private static final String EXTERNAL_PROJECT_SECTION = "ExternalProjectImportWizard";//$NON-NLS-1$
	private WizardAssignmentsImportPage mainPage;
     ...
     */
    public ExternalAssignmentImportWizard() {
    	this(null);
    }
     ...
     * @since 3.5
     */
    public ExternalAssignmentImportWizard(String initialPath)
    {
        super();
    ...
    public void addPages() {
        super.addPages();
		mainPage = new WizardAssignmentsImportPage(
