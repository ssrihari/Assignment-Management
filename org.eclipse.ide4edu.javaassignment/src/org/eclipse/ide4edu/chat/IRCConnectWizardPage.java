...
final class IRCConnectWizardPage extends WizardPage {
	...
	IRCConnectWizardPage(String authorityAndPath, String ircFromFile) {
		this();
		this.authorityAndPath = authorityAndPath;
		fromFile=ircFromFile;
		System.out.println("String in PageConstructr"+fromFile);
	...
	public void createControl(Composite parent) {
		...
		/*connectText.setText(NLS.bind(
				...
				getRandomNumber()));
				*/
			//the connectID is set from the TAContact.txt file
		connectText.setText(fromFile);
